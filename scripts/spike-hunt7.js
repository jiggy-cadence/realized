...
async function main() {
  ...
  console.log('WALK-FORWARD v7 -- per-pool attribution + trimmed mean');
  ...
  writeFileSync(new URL('../data/spike-hunt7.json', import.meta.url), JSON.stringify({
