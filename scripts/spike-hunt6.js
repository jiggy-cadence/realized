...
async function main() {
  ...
  console.log('WALK-FORWARD v6 -- ALL 5 VENUES, STEP 7d (n>>9)');
  ...
  writeFileSync(new URL('../data/spike-hunt6.json', import.meta.url), JSON.stringify({
